...
#ifndef POINTCLOUD_CONFIGURATION_H
...
class POINTCLOUD_EXPORT Configuration
{
protected:
  struct _Path
  {
...
public:
  ...
  inline static bool setSDKPath(const String &path) { return setEnvironmentVariable("POINTCLOUD_SDK_PATH", path); }
  inline static bool getSDKPath(String &path) { return getEnvironmentVariable("POINTCLOUD_SDK_PATH", path); }
...
class POINTCLOUD_EXPORT ConfigSet
{
protected:
...
class POINTCLOUD_EXPORT ConfigurationFile
{
protected:
