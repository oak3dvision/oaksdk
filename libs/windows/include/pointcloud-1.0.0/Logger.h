...
#ifndef POINTCLOUD_LOGGER_H
#define POINTCLOUD_LOGGER_H
...
class POINTCLOUD_EXPORT LoggerOutStream
{
public:
...
class POINTCLOUD_EXPORT Logger
{
protected:
...
//POINTCLOUD_EXPORT Logger & endl(Logger &l);

class POINTCLOUD_EXPORT LogLevelChanger
{
